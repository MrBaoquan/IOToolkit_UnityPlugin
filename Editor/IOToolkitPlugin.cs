...
public class IOToolkitPlugin
{
    ...
    //         IOSettings.SetIOLogDir(Path.Combine(Application.dataPath, "Plugins/IOToolkit/Logs"));
    //     }
    ...
    public static void OnPostprocessBuild(BuildTarget target, string pathToBuiltProject)
    {
        ...
        File.Copy(
            Path.Combine(_srcPluginsDir, $"Plugins/{_platform}", "IOTester.exe"),
            Path.Combine(_buildPluginsDir, $"{_platform}/IOTester.exe"),
            true
        );
